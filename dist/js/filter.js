  ...
  methods: {
    handleFromChange: function handleFromChange(value) {
      this.$store.commit("".concat(this.resourceName, "/updateFilterState"), {
        ...
        value: _objectSpread(_objectSpread({}, this.value), {}, {
          from: value
        })
      });
      this.$emit('change');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    handleChange: function handleChange(event) {
       ...
       */
      if (!this.filter.options.filterOnSingleParamExists && Number.isNaN(parseInt(this.value.from)) !== Number.isNaN(parseInt(this.value.to))) {
        return;
      }

      this.$store.commit("".concat(this.resourceName, "/updateFilterState"), {
        filterClass: this.filterKey,
        value: _objectSpread(_objectSpread({}, this.value), {}, _defineProperty({}, event.target.name, event.target.value))
      });
      this.$emit('change');
    }
  },
...
var render = function() {
  ...
  return _c("div", { staticClass: "range-date-filter" }, [
    _c(
      "h3",
...
module.exports = __webpack_require__(/*! /var/www/work/test-laravel-rent-dashboard/packages/nova-range-input-filter/resources/js/filter.js */"./resources/js/filter.js");
